  ...
  for (const participant of participants) {
    try {
      ...
      if (customMessage) {
        ...
        finalMessage = 
`╭╼━≪•عضو جديد•≫━╾╮
┃منور ياحب @${displayName} 👀
┃عدد الأعضاء : #${groupMetadata.participants.length} ❤️✨
┃الوقت: ${timeString} ⏰
╰━━━━━━━━━━━━━━━╯

*@${displayName}* منور ياحب ف *${groupName}* 👀❤️
*وصف الجروب* 📝\n
${groupDesc}

> *Powered by ✪『𝙇𝙐𝘾𝙄𝙁𝙀𝙍』✪ر*`;
      }
      ...
      if (customMessage) {
        ...
        fallbackMessage = `منور ياحب @${user} ف ${groupName} 🎉`;
      }
