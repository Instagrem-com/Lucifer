...
module.exports = {
    ...
    async handler(sock, message, args, context = {}) {
      ...
      `*الإجراء الحالي 👀❤️:* ${config?.action || 'مفيش حاجة متضبطة'}\n\n` +
      `*الأوامر 💻 :*\n` +
      `• \`.ممنوع_اللينكات تفعيل\` - شغّل مانع اللينكات 👀❤️\n` +
      `• \`.ممنوع_اللينكات تعطيل\` - وقف مانع اللينكات 👀❤️\n` +
      ...
      `📝 *اللينكات اللي مينفعش تتبعت*📝 :\n` +
      `• جروبات واتساب 🌐\n` +
      `• قنوات واتساب 📢\n` +
      `• تليجرام ✈️\n` +
      `• أي لينكات تانية 🔗\n\n` +
      `*ملاحظة* 👀❤️\n والأدمن وصاحب الجروب والمطور يـبعتو لينك براحتهم 😉❤️`
            }, { quoted: message });
            return;
        }
        ...
        switch (action) {
            case 'تفعيل':
                ...
                await sock.sendMessage(chatId, {
                    text: result 
      ? 'مانع اللينكات اتفعل 👀❤️\nالإجراء الافتراضي 📝: حذف الرسائل 🗑️\nالمعفيين : والأدمن وصاحب الجروب والمطور 😉❤️' 
      : 'ف مشكلة ف تفعيل مانع اللينكات 🙂'
                }, { quoted: message });
                break;
            ...
            case 'ضبط':
                if (args.length < 2) {
                    await sock.sendMessage(chatId, {
                        text: 'استنى يا حـب لازم تحدد الإجراء 👀📝\nطريقة الاستخدام ⚙️: `.ممنوع_اللينكات ضبط حذف|طرد|تحذير 👀❤️`'
                    }, { quoted: message });
                    return;
                }
                ...
                const actionDescriptions = {
                    حذف: 'امسح الرسائل وابعث تحذير للمستخدمين 👀❤️',
                    طرد: 'امسح الرسائل واطرد الشخص من الجروب 👀❤️',
                    تحذير: 'ابعت تحذير للمستخدم بس 👀❤️'
                };
                await sock.sendMessage(chatId, {
                    text: setResult 
      ? `خلاص اتظبط الإجراء 👀❤️\n${setAction} - ${actionDescriptions[setAction]}\nالمعفيين 📝 : والأدمن وصاحب الجروب والمطور 😉❤️` 
      : 'ف مشكلة ف ضبط الإجراء 🙂'
                }, { quoted: message });
                break;
      ...
      `*الحالة دلوقتي* 👀❤️ : ${status?.enabled ? 'شغال ✅' : 'واقف ❌'}\n` +
      `*الإجراء الحالي* ⚙️ : ${status?.action || 'مفيش حاجة متضبطة 😊❤️'}\n\n` +
      `*اللي بيحصل لو حد بعث لينك* ❤️🔥\n` +
      ...
      `*المعفيين:* والأدمن وصاحب الجروب والمطور 😉❤️`
            ...
            default:
                await sock.sendMessage(chatId, {
                    text: 'الأمر اللي كتبته مش صح 👀❤️\nاستخدم `.ممنوع_اللينكات` عشان تشوف كل الاختيارات 😊❤️'
                }, { quoted: message });
        }
    },
