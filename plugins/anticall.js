      ...
      return await sock.sendMessage(
        chatId,
        {
          text: '*⚡ إعدادات مانع المكالمات ⚡*\n\n' +
                ...
                '*الاوامـر 👀❤️:*\n' +
                '• `.ممنوع_المكالمات تفعيل` - تفعيل ⚡⚙️\n' +
                '• `.ممنوع_المكالمات تعطيل` - تعطيل 💤⚙️\n' +
                '• `.ممنوع_المكالمات عرض` - عرض الحالة الحالية 📝⚙️\n\n' +
                `*الـحـالـة الحالية 👀❤️:* ${state.enabled ? ' مـفـعـل ✅' : ' مـعـطـل ❌'}\n` +
                `*التخـزيـن* ⚙️: ${HAS_DB ? 'Database' : 'نظام الملفات 💻'}`
        },
        { quoted: message }
      );
    }
      ...
      return await sock.sendMessage(
        ...
        { 
          text: `📵 *حـالـة مانع المكالمات* 📵\n\n` +
                ...
                `${state.enabled ? 'كـل الـمـكـالـمـات الـواردة هـتـتـكـلـسـن يـا حـب 👀❤️' : 'الـمـكـالـمـات الـواردة مسـمـوحـه دلـوقـتـي ⚡❤️'}`
        },
        { quoted: message }
      );
    }
    ...
    await sock.sendMessage(
      ...
      { 
        text: `📵 *حـالـة مانع المكالمات 📵${enable ? 'مـفـعـل ✅' : 'مـعـطـل ❌'}*\n\n` +
              `${enable ? ' الـمـكـالـمـات الـواردة هـتـتـكـلـسـن تـلـقـائي يـا حـب ✅' : ' الـمـكـالـمـات الـواردة مـسـموحه يـا حـب 👀❤️ '}`
      },
      { quoted: message }
    );
  },
