...
module.exports = {
  ...
  usage: '.ملصق2 (رد على صورة أو فيديو)',
  ...
  async handler(sock, message, args, context) {
    ...
    if (!mediaMessage) {
      await sock.sendMessage(
        chatId,
        {
          text: '⚠️ رد على صورة أو فيديو واكتب .ملصق2 لتحويله إلى ملصق.',
          ...channelInfo
        },
    ...
    try {
      ...
      const json = {
        ...
        'sticker-pack-name': settings.packname || 'بوت واتساب',
        emojis: ['🤖']
      };
      ...
      await sock.sendMessage(
        chatId,
        {
          text: '❌ فشل إنشاء الملصق، حاول مرة أخرى لاحقاً.',
          ...channelInfo
        },
        { quoted: messageToQuote }
      );
