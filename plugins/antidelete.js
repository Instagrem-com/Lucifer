...
module.exports = {
    command: 'ممنوع_مسح_الرسايل',
    aliases: ['م_ح_س', 'منع_حذف_الرسايل'],
    category: 'اوامـࢪ الـمـطـوࢪ',
    description: 'تـفـعـيـل أو تـعـطـيـل نـظـام مـنـع الحـذف لمـتـابـعـة الرسـائـل الـمـحـذوفـة',
    usage: '.ممنوع_مسح_الرسايل <تفعيل|تعطيل>',
    ownerOnly: true,
        ...
        if (!action) {
            await sock.sendMessage(chatId, {
                text: `*🔰 إعدادات مانع حذف الرسائل 🔰*\n\n` +
                      ...
                      `*المميزات 😉❤️:*\n` +
                      `• متابعة الرسائل المحذوف 🔥\n` +
                      `• حفظ الوسائط المحذوفة 🔥\n` +
                      `• حفظ الرسائل المحذوفه 🔥ً\n` +
